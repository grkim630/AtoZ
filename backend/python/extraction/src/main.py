...
from src.schemas import CleanResult, IngestTextRequest
from src.utils_mask import mask_sensitive
from src.utils_risk import detect_signals, score_risk
from src.services_llm import llm_extract
from src.services_stt import stt_transcribe
from src.services_eval import evaluate_clean_text

from src.config import settings
from src.services_ocr import ocr_extract_text  # 키 없으면 아래에서 데모 처리
...
def analyze_pipeline(source_type: str, raw_text: str) -> CleanResult:
    ...
    # (선택) evaluation 모델 추론(실패해도 파이프라인은 계속)
