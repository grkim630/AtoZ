    ...
    return (<react_native_1.SafeAreaView style={styles.safe}>
      ...
      <react_native_1.View style={styles.header}>
        ...
        <react_native_1.View style={styles.headerCenter}>
          <react_native_1.Text style={styles.headerTitle}>전화 사기</react_native_1.Text>
        </react_native_1.View>
      ...
      <react_native_1.View style={styles.searchWrap}>
        <react_native_1.View style={styles.searchBar}>
          <react_native_1.TextInput placeholder="검찰청에서 전화가 걸려 왔어요." placeholderTextColor="#9CA3AF" style={styles.searchInput}/>
      ...
      <react_native_1.ScrollView contentContainerStyle={styles.grid} showsVerticalScrollIndicator={false}>
        {DATA.map((item) => (<react_native_1.Pressable key={item.id} style={styles.card} onPress={() => goTo(item.id)}>
        ...
        <react_native_1.View style={{ height: 30 }}/>
